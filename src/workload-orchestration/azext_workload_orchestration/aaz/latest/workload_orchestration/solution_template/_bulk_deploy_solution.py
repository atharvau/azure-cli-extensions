...
class BulkDeploySolution(AAZCommand):
    ...
    :example: Create a BulkDeploySolution
        az workload-orchestration solution-template bulk-deploy-solution --resource-group rg1 --solution-name st1 --solution-version 1.0.0 --targets '[{"solution-version-id": "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Edge/targets/target1/solutions/solution1/versions/1.0.0"}]'
    """
