...
@register_command(
    "workload-orchestration solution-template version bulk-publish-solution",
)
class BulkPublishSolution(AAZCommand):
    ...
    _aaz_info = {
        "version": "2025-06-01",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/private.edge/solutiontemplates/{}/versions/{}/bulkpublishsolution", "2025-06-01"],
        ]
    }
    ...
    class SolutionTemplateVersionsBulkPublishSolution(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.Edge/solutionTemplates/{solutionTemplateName}/versions/{solutionTemplateVersionName}/bulkPublishSolution",
                **self.url_parameters
            )
